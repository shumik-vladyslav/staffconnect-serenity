...
export class AppMenuComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(public app: AppComponent, private contentService: ContentService) {}
    ...
    ngOnInit() {
        this.model = [
          ...
          {
            label: 'Users', icon: 'users', command: (event) => {
            this.contentService.addTab({
              'id'   : 'sample',
              'title': 'Users',
          ...
          {
            label: 'Schedule', icon: 'users',
            items: [
              {label: 'Calendar', icon: 'view_quilt', command: (event) => {
                this.contentService.addTab({
                  'id'   : 'Calendar',
                  'title': 'Calendar',
                  'translate': 'NAV.SAMPLE.TITLE',
